...
purple_trendyol_cart_css = """
/* ==========================================================================
   MOBELMOR PURPLE LUXURY E-COMMERCE CART DRAWER (NO ORANGE - PURE MOBELMOR)
   ========================================================================== */
...
# Replace any existing cart drawer styles
if "MOBELMOR TRENDYOL-STYLE HIGH-CONVERSION CART DRAWER" in orig_css:
    orig_css = orig_css.split("/* ==========================================================================\n   MOBELMOR TRENDYOL-STYLE HIGH-CONVERSION CART DRAWER")[0]
...
print("Updated styles.css with Pure Mobelmor Purple Theme!")
