...
const PRODUCTS = [
  {
    ...
    "desc": "Zara Yemek Odası Takımı Siyah ile modern ve şık bir yemek alanı yaratın. İnegöl usta zanaatkarlarının el işçiliği masif ahşap işleme, akrilik siyah lake mermer doku, bronz pirinç detaylı ayaklar ve fonksiyonel aynalı konsoluyla evinize değer ve ahenk katar.",
    "specs": {
      "Modül": "Genişlik",
